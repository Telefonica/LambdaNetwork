...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000, in_channels=3):
        ...
        self.conv1 = nn.Conv1d(in_channels, 64, kernel_size=5, stride=2, padding=2, bias=False)
...
class LambdaResNet15(nn.Module):
    def __init__(self, in_channels, n_maps):
        ...
        for i, lambdaLayer in enumerate(self.lambdas):
            self.add_module("bn_lambda{}".format(i + 1), nn.BatchNorm1d(n_maps, affine=False))
